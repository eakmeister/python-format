...
C = [10000, 200000, 3000000, 40000000, 500000, 60000, 700000, 8000000, [900, 1000, 20000]]

D = [0000000, [11111111, 222222222, 333333, 444444444, 5555555555, 666666666, 77], [8888888, 9999999999, 000000000, 111111111, 222222222, 333333333, 44444444]]

class Test(object):
    def __init__(self):

        self.x = 'this:is:a:stringggggggggggggggggggggggggggggggggggggggggggggggg'
        self.y =90 + \
                80 + \
                3
